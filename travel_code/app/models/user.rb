...
class User < ActiveRecord::Base
  ...
  def favorite(attraction)
    attraction_relationships.create(attraction_id: attraction.id)
  end

  def unfavorite(attraction)
    attraction_relationships.find_by(attraction_id: attraction.id).destroy
  end
